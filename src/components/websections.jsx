...
export function FAQ() {
    return (
      <section id="faq">
        ...
        <Accordion defaultIndex={[0]}allowMultiple width={700}>
            <AccordionItem>
                <hr/>
                <h2>
                    <AccordionButton border='none' bg='none' color='white' mt={4}>
                ...
                <AccordionPanel pb={4} pt={8} fontSize={14}>
            ...
            <AccordionItem>
                ...
                <AccordionPanel pb={4} pt={8} fontSize={12}>
